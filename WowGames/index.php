...
?>
<!--Alerta para ver Carrito de Compra-->
<br>
<?php if ($mensaje != "") { ?>
...
<div class="jumbotron">
    <h1 class="display-4">¡Bienvenido a WowGames!</h1>
    <h4>Tienda de Videojuegos</h4>
    <p>Descubre una gran selección de videojuegos increíbles.</p>
</div>
